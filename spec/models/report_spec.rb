...
RSpec.describe Report, type: :model do
  ...
  let!(:user_manager) {FactoryBot.create :user, id: 2, role: :normal}
  let!(:user_admin) {FactoryBot.create :user, id: 3, role: :admin}
  let!(:user_singe) {FactoryBot.create :user, id: 4, role: :normal}
  let!(:department) {FactoryBot.create :department, id: 1}
  let!(:department_2) {FactoryBot.create :department, id: 2}
  ...
  let!(:report_1) {FactoryBot.create :report, id: 1, from_user_id: user.id, to_user_id: user_manager.id, department_id: department.id}
  let!(:report_2) {FactoryBot.create :report, id: 2, from_user_id: user.id, to_user_id: user_manager.id, department_id: department.id}
  let!(:report_3) {FactoryBot.create :report, id: 3, from_user_id: user.id, to_user_id: user_manager.id, department_id: department.id, report_status: 1}
  let!(:report_4) {FactoryBot.create :report, id: 4, from_user_id: user_singe.id, to_user_id: user_manager.id, department_id: department.id}
  let!(:report_5) {FactoryBot.create :report, id: 5, from_user_id: user_singe.id, to_user_id: user_manager.id, department_id: department_2.id, report_date: "2022-02-02"}
